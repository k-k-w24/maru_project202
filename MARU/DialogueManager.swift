...
////            非同期で fetchOpenAIResponse を呼び出し、結果を受け取る
////        response = await FetchOpenAIManager.fetchOpenAIResponse()
//        print("OpenAIからの応答: \(String(describing: response))")
//       }
//    
//    func populateDialogue() async{
//        
//        greetings = []
//        addHello(msg: response ?? "nilです")
//        addHello(msg: response ?? "nilです")
//        addHello(msg: response ?? "nilです")
//        
//        dialogue = []
